...
export default function TermsOfUse() {
  return (
    <LegalPage title="Terms of Use" updated="August 4, 2026">
      <section><h2 className="text-xl text-foreground">Using AQLA</h2><p className="mt-3">AQLA provides tools to help you understand cognitive patterns, habits, and neural-wellness goals. This includes the Cognitive Toolkit, which presents formula families matched to your cognitive profile, and the in-app Help Assistant, which answers questions about your results and how to use the platform. You are responsible for the accuracy of the information you enter and for keeping your account credentials secure.</p></section>
      <section><h2 className="text-xl text-foreground">Not medical advice</h2><p className="mt-3">AQLA does not diagnose, treat, prevent, or cure any condition. Its assessments, protocols, Cognitive Toolkit formulas, Help Assistant guidance, AI responses, and educational content are for general wellness and informational purposes only. They do not replace care from a qualified clinician.</p></section>
      <section><h2 className="text-xl text-foreground">Safety</h2><p className="mt-3">Do not use AQLA to make medication or supplement decisions or delay professional care. Seek qualified medical advice for symptoms, safety concerns, or questions about supplements, interactions, or health conditions. Follow any safety prompts shown in the app.</p></section>
