...
export default function IdeaDetailPopover({ idea, variant = "checklist" }) {
  ...
  return (
    <div className="pointer-events-none absolute left-0 top-full z-30 mt-2 hidden w-[min(30rem,85vw)] rounded-2xl border border-border bg-popover p-4 shadow-2xl group-hover:block">
